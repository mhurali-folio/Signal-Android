...
class OnBoardingFragment : AppIntroBaseFragment() {
  ...
  companion object {
     ...
     *
     * @return An [OnBoardingFragment] created instance
     */
    @JvmOverloads
    @JvmStatic
    fun newInstance(
    ...
    /**
     * Generates an [OnBoardingFragment] from a given [SliderPage]
     *
     ...
     */
    @JvmStatic
    fun newInstance(sliderPage: SliderPage): OnBoardingFragment {
      val slide = OnBoardingFragment()
